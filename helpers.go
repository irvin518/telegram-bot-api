...
// NewInvoiceLink creates a new Invoice request to the user.
func NewInvoiceLink(title, description, payload, providerToken, currency string, prices []LabeledPrice) InvoiceLink {
	return InvoiceLink{
		Title:         title,
		Description:   description,
		Payload:       payload,
